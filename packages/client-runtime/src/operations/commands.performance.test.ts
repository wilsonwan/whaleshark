...
// the shell's `providerInstanceId` and its `modelSelection.instanceId`.
const HISTORICAL_FULL_PROJECTION_APPLICATION_BYTES = 10_371_413;
...
const HISTORICAL_FORMER_SEND_APPLICATION_BYTES = 10_371_672;
...
const FORMER_SEND_RPC_JSON_BYTES = 10_372_178;
