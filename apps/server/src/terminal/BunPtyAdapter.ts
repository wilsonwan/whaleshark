...
export class BunPtyUnsupportedPlatformError extends Schema.TaggedError<BunPtyUnsupportedPlatformError>()(
  ...
  override get message(): string {
    return `Bun PTY terminal support is unavailable on ${this.platform}. Please use Node.js (e.g. by running \`node apps/server/src/bin.ts\` from the repository root) instead.`;
  }
}
