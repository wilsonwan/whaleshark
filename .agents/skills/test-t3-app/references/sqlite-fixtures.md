...
For a substantial current example, inspect the seeding helpers under `apps/server/src/`. Adapt the column set to the target database instead of assuming copied SQL remains current.
